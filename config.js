...
export const WEDDING_DATE = "2025년 06월 21일 토 13:00 ~ 15:00";
export const WEDDING_TIME = "13:00 ~ 15:00";
export const WEDDING_LOCATION = "대전광역시 대덕문화원";

export const GROOM_NAME = "○○○";
export const GROOM_ACCOUNT_NUMBER = "○○은행 ***-***-******";
export const GROOM_FATHER_NAME = "";
export const GROOM_FATHER_ACCOUNT_NUMBER = "농협은행 356-1564-2523-93";
